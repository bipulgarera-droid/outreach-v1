...
MOCK_SUBJECT_MAP = {
    'scaling mandy kay marketing?': [('c1', 'p1', 'mandy@mandykaymarketing.com', 'Mandy Kay Marketing')],
    'scaling fast hippo media?': [('c4', 'p1', 'oscar.fullmer@fasthippomedia.com', 'Fast Hippo Media')],
    'quick one for immensity it': [('c2', 'p1', 'immensityit@gmail.com', 'Immensity It')],
    'scaling peppershock?': [('c3', 'p1', 'rhea@peppershock.com', 'Peppershock')],
    'quick question about "colage communication': [('c5', 'p2', 'action@colagecommunication.in', 'Colage Communication')],
    'scaling melt sports/culinary/ entertainment?': [('c6', 'p2', 'vince@meltatl.com', 'Melt Sports')],
    'scaling mks web design?': [('c7', 'p2', 'anthony@mkswebdesign.com', 'MKS Web Design')],
    'scaling aqaba digital?': [('c8', 'p3', 'rs@aqaba.digital', 'Aqaba Digital')],
    'scaling m4 worldwide?': [('c9', 'p3', 'marcelo@m4worldwide.com', 'M4 Worldwide')],
    'scaling smb 360?': [('c10', 'p3', 'ray@smb360.io', 'SMB 360')],
    'scaling elevation': [('c11', 'p3', 'colan@schureconsulting.com', 'Schure Consulting')],
    'scaling sandpiper agency?': [('c12', 'p3', 'ashley@sandpiperagency.com', 'Sandpiper Agency')],
    'scaling bob gold & associates?': [('c13', 'p3', 'bob@bobgoldpr.com', 'Bob Gold & Associates')],
    'scaling mailpix?': [('c14', 'p1', 'peter@mailpix.com', 'Mailpix')],
    'scaling stand out consulting services?': [('c15', 'p3', 'julianano@standoutconsultingservices.com', 'Stand Out Consulting')],
    'scaling relentless digital marketing solutions?': [('c16', 'p3', 'jcrouch@relentless-digital.com', 'Relentless Digital')],
    'scaling consult vito?': [('c18', 'p2', 'unknown@consultvito.com', 'Consult Vito')],
    'scaling internet marketing pros?': [('c19', 'p2', 'unknown@internetmarketingpros.com', 'Internet Marketing Pros')],
    'scaling revline marketing?': [('c20', 'p2', 'unknown@revlinemarketing.com', 'Revline Marketing')],
    'for your consideration: "embers of us" (short film)': [('c17', 'p1', 'education@cineworks.ca', 'Cineworks')],
}
